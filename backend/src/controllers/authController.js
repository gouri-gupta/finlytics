...
export const registerUser=async (request,response)=>{
    ...
    try {
        ...
        return response.status(201).send({"message":"Registration successful!New user created","success":true,"result":{"_id":newUser._id,name,email}})
    } 
    catch (error) {
...
export const loginUser=async (request,response)=>{
    ...
    try {
        ...
        //toekn stores the id of the user 
